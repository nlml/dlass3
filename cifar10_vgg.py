...
def preprocess_cifar10_data(X_train_raw, Y_train_raw, X_test_raw, Y_test_raw):
  ...
  # Subtract the mean image used in training VGG (https://www.cs.toronto.edu/~frossard/vgg16/vgg16.py)
  #mean_image = np.array([123.68, 116.779, 103.939], dtype=np.float32).reshape((1, 1, 3))
  #X_train -= mean_image
  #X_test -= mean_image
